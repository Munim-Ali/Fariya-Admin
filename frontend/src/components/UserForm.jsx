            ...
            <form onSubmit={onSubmit}>
                <div className="inline-form-fields">
                    ...
                    <div className="user-reg-form-group">
                        ...
                        <input type="text" name="mobileNumber_1" id="mobileNumber_1"
                            value={mobileNumber_1}
                            onChange={onChange}/>
                    </div>
                    <div className="user-reg-form-group">
                        <label htmlFor="text">Alternate Mobile Number</label>
                        <input type="text" name="mobileNumber_2" id="mobileNumber_2"
                    ...
                    <div className="user-reg-form-group">
                        ...
                        <input type="text" name="userPackage" id="userPackage"
                            value={userPackage}
                            onChange={onChange}/>
                    </div>
                    <div className="user-reg-form-group">
